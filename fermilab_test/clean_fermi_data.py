...
hxres = [
        TH1F("hxres0", "h_xres_gem0", 1000, -0.5, 0.5),
        TH1F("hxres1", "h_xres_gem1", 1000, -0.5, 0.5),
        TH1F("hxres2", "h_xres_gem2", 1000, -0.5, 0.5),
        TH1F("hxres3", "h_xres_gem3", 1000, -0.5, 0.5),
        ]
hyres = [
        TH1F("hyres0", "h_yres_gem0", 1000, -0.5, 0.5),
        TH1F("hyres1", "h_yres_gem1", 1000, -0.5, 0.5),
        TH1F("hyres2", "h_yres_gem2", 1000, -0.5, 0.5),
        TH1F("hyres3", "h_yres_gem3", 1000, -0.5, 0.5)
        ]
...
for track in total_tracks:
    ...
    for i in range(len(track)):
        zi = track[i].z
        pt = project.solve(cross_point, direction, zi)
        dx = pt.x - track[i].x
        dy = pt.y - track[i].y
...
for i in range(4):
    ...
    hxres[i].Fit("gaus", "", "",  -0.1, 0.1)
    hxres[i].Write()
for i in range(4):
    ROOT.gStyle.SetOptFit(1111)
    hyres[i].Fit("gaus", "", "", -0.1, 0.1)
    hyres[i].Write()
